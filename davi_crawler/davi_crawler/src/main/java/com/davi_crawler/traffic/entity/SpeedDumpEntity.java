...
@SequenceGenerator(
        name = "SPEED_DUMP_SEQ",
        sequenceName = ConstantUtil.SPEEDDUMP_SEQ_NAME,
        initialValue = 1,
        allocationSize = 1
)
@Table(name="DV_TRAFFIC_SPEED_DUMP")
public class SpeedDumpEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SPEED_DUMP_SEQ")
    ...
    public SpeedDumpDto toDto(){
        return SpeedDumpDto.builder()
