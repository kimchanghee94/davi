...
import com.davi_crawler.traffic.service.CrosswalkService;
...
public class CrosswalkController {
    ...
    //http://localhost:8282/traffic/crosswalk/update
    ...
    public Map<String, Object> updateApiData(){
        ...
        try{
            result = crosswalkService.updateApiData();
        }catch (Exception e){
            e.printStackTrace();
            result.put("success", false);
            result.put("message", "횡단보도 정보 업데이트 실패");
        }
